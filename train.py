...
def data_config(parser):
    parser.add_argument('--log_dir ', type=str, default='', help='driectory for log.')
...
def train_config(parser):
    ...
    parser.add_argument('--task_config_path', type=str, default='config/tasks_config.json')
...
def main():
    ...
    if os.path.exists(model_path):
        ...
        # Keep using the very original config - shit for mt-dnn team wrote a big bug here, shame on the team
        config = {'vocab_size': 30522, 'hidden_size': 768, 'num_hidden_layers': 12, 'hidden_act': 'gelu', 'intermediate_size': 3072, 
    ...
    for epoch in range(0, args.epochs):
        ...
        for idx, dataset in enumerate(args.test_datasets):
            ...
            if dev_data is not None:
                ...
                results = {'metrics': dev_metrics, 'uids': dev_ids, 'labels': golds, 'predictions': dev_predictions, 'scores': scores}
